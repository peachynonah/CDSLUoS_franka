...
rpy_info = [
    ("bodyRPY_des_R", "bodyRPY_R", "error_ana_rx", "Base Euler Z (Z-Y-X)"),
    ("bodyRPY_des_P", "bodyRPY_P", "error_ana_ry", "Base Euler Y (Z-Y-X)"),
    ("bodyRPY_des_Y", "bodyRPY_Y", "error_ana_rz", "Base Euler X (Z-Y-X)"),
]
